...
exports.handler = function(event, context, callback){
 ...
 async function createSession(user_name_str, new_session_id_str){
     var
         params = {
             Item: {
                 "session_id": { S: new_session_id_str
                 },
                 "user_name": { S: user_name_str
                 },
                 "expiration_time": { N: (Math.floor((new Date).getTime()/1000) + (60 * SESSION_TIMEOUT_IN_MINUTES_INT)).toString()
                 }
             },
